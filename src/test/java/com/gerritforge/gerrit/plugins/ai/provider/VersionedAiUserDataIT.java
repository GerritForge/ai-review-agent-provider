...
public class VersionedAiUserDataIT extends AbstractTokenIT {
  ...
  @Test
  public void setTokenPersistsAiUserConfig() throws Exception {
    String encryptedToken = "encrypted-token";

    VersionedAiUserData aiUserConfig = aiTokenFactory.create(user.id()).load();
    aiUserConfig.setToken(TEST_PROVIDER_PLUGIN_NAME, encryptedToken);
