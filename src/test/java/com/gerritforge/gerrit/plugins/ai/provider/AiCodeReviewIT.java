...
public class AiCodeReviewIT extends AbstractTokenIT {
  ...
  public void shouldGenerateAiCodeReviewWithUserToken() throws Exception {
    ...
    RestResponse aiReviewResult =
        userRestSession.post(
            getAiCodeReviewUri(createNewChange()),
  ...
  @Test
  public void shouldReturnBadRequestForUnknownAiReviewProvider() throws Exception {
    addApiToken();
  ...
  @Test
  public void shouldReturnBadRequestForUnknownAiModel() throws Exception {
    addApiToken();

    RestResponse aiReviewResult =
        userRestSession.post(
            getAiCodeReviewUri(createNewChange()),
            new AiCodeReview.Input(TEST_PROVIDER_PLUGIN_NAME, "unknown-ai-model", ""));
    aiReviewResult.assertBadRequest();
  }
  ...
  private void addApiToken() throws Exception {
  ...
  private Change createNewChange() throws Exception {
    PushOneCommit.Result changeToReview = createChange();
    changeToReview.assertOkStatus();
    return changeToReview.getChange().change();
  }
}
