...
The list of AI providers' modules by each provider is kept in a Gerrit persistent cache, which by default expires
after 1 day.
...
For more details on all the cache settings, please refer to the official documentation
